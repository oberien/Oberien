package model.unit.lightVehicle;
...
public class LightVehicle extends Unit implements AttackingModel {
	private int damage;
	private int strike;
	private int attackRange;
	private Type strongAgainst;

	public LightVehicle(String name, Type type, int id, Player player,
